...
plot(s,
       dunif(s, 0, 1),
       main = "Uniform Unif(0,1)",
       type = "l",
       ylim = c(0, 1)
)
plot(s,
       dexp(s, 1),
       main = "Exponential Exp(1)",
       type = "l",
       ylim = c(0, 1)
)
plot(s,
...
lines(
       seq(-0.2, 1.2, length = 100),
       dunif(seq(-0.2, 1.2, length = 100)),
       col = "blue",
       lty = 2,
       lwd = 2
)
